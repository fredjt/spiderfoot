...
class sfp_vxvault(SpiderFootPlugin):
    ...
    meta = {
        ...
        'dataSource': {
            ...
            'description': "VxVault is a malware management program to automatically "
            "download and classify malware samples.\n"
            "It downloads samples from online sources (webpages, RSS feeds), "
            "attempts to identify malware using VirusTotal, "
            "then stores them on a local file system and SQLite database.",
        }
    }
