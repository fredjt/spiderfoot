...
class sfp_hunter(SpiderFootPlugin):
    ...
    meta = {
        ...
        'dataSource': {
            ...
            'logo': "https://hunter.io/touch-icon.png",
            'description': (
                "Hunter lets you find email addresses in seconds and connect "
                "with the people that matter for your business.\n"
                "The Domain Search lists all the people working in a company "
                "with their name and email address found on the web. With 100+ "
                "million email addresses indexed, effective search filters and "
