...
class sfp_cleantalk(SpiderFootPlugin):
    ...
    meta = {
        ...
        'dataSource': {
            ...
            'description': "CleanTalk is a Cloud-Based spam filtering service to protect websites. "
            ...
            "With our cloud spam checker, your website is protected from spam bots and comments.",
        }
    }
