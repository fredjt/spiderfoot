...
class sfp_tool_onesixtyone(SpiderFootPlugin):
    ...
    opts = {
        ...
        'communities': ','.join([
            ...
            'SNMP', 'SUN', 'access', 'admin', 'agent', 'all', 'cisco',
            'community', 'default', 'enable', 'field', 'guest', 'hello',
            'ibm', 'manager', 'mngt', 'monitor', 'netman', 'network',
            'none', 'openview', 'pass', 'password', 'private', 'proxy',
            'public', 'read', 'read-only', 'read-write', 'root', 'router',
            'secret', 'security', 'snmp', 'snmpd', 'solaris', 'sun',
            'switch', 'system', 'tech', 'test', 'world', 'write'
        ]),
        'netblockscan': True,
        'netblockscanmax': 24
    }
