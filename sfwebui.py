...
class SpiderFootWebUi:
    ...
    def __init__(
        ...
        cherrypy.config.update({
            ...
            "tools.response_headers.headers": secure_headers.headers.items()
        })
    ...
    def searchBase(self: 'SpiderFootWebUi', id: str = None, eventType: str = None, value: str = None) -> list:
        ...
        except (sqlite3.Error, TypeError, OSError, ValueError):
            return retdata
    ...
    def query(self: 'SpiderFootWebUi', query: str) -> str:
        ...
        except (sqlite3.Error, TypeError, OSError) as e:
